...
execute if entity @s[advancements={minecraft:adventure/play_jukebox_in_meadows=true}] if entity @s[tag=!C33] run function cassette:music/songs/33 {storage:"cassette",path:"collect",tag:"C33",eparen:""}
execute if entity @s[advancements={minecraft:end/respawn_dragon=true}] if entity @s[tag=!C37] run function cassette:music/songs/37 {storage:"cassette",path:"collect",tag:"C37",eparen:""}
execute if entity @s[advancements={cassette:challenges/hammer=true}] if entity @s[tag=!C38] run function cassette:music/songs/38 {storage:"cassette",path:"collect",tag:"C38",eparen:""}
execute if entity @s[advancements={minecraft:end/root=true}] if entity @s[tag=!C39] run function cassette:music/songs/39 {storage:"cassette",path:"collect",tag:"C39",eparen:""}
execute if entity @s[advancements={minecraft:nether/get_wither_skull=true}] if entity @s[tag=!C41] run function cassette:music/songs/41 {storage:"cassette",path:"collect",tag:"C41",eparen:""}
execute if entity @s[advancements={cassette:challenges/buddy=true}] if entity @s[tag=!C43] run function cassette:music/songs/43 {storage:"cassette",path:"collect",tag:"C43",eparen:""}
execute if entity @s[advancements={minecraft:end/kill_dragon=true}] if entity @s[tag=!C51] run function cassette:music/songs/51 {storage:"cassette",path:"collect",tag:"C51",eparen:""}
execute if entity @s[advancements={minecraft:husbandry/whole_pack=true}] if entity @s[tag=!C54] run function cassette:music/songs/54 {storage:"cassette",path:"collect",tag:"C54",eparen:""}
execute if entity @s[advancements={cassette:challenges/feel=true}] if entity @s[tag=!C55] run function cassette:music/songs/55 {storage:"cassette",path:"collect",tag:"C55",eparen:""}
execute if entity @s[advancements={minecraft:adventure/very_very_frightening=true}] if entity @s[tag=!C56] run function cassette:music/songs/56 {storage:"cassette",path:"collect",tag:"C56",eparen:""}
execute if entity @s[advancements={minecraft:nether/return_to_sender=true}] if entity @s[tag=!C57] run function cassette:music/songs/57 {storage:"cassette",path:"collect",tag:"C57",eparen:""}
