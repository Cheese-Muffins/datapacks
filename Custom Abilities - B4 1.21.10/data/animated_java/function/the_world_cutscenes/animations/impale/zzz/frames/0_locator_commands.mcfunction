...
function custom:abilities/the_world/skin {rig:"the_world_cutscenes",objective:"customTheWorld.ImpaleID"}
playsound minecraft:the_world.impale.laugh player @a ~ ~ ~ 0.5