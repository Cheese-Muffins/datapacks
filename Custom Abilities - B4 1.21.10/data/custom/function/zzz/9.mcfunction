...
execute if score @s customBilly.TrapLinger matches 20.. run function custom:zzz/10
execute if entity @e[type=!#custom:not_mob,distance=..1.75] run function custom:zzz/12
