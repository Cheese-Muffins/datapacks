...
execute if score @s customUniversal.Move5Cooldown matches 1.. run scoreboard players remove @s customUniversal.Move5Cooldown 1
execute if score @s customUniversal.Move6Cooldown matches 1.. run scoreboard players remove @s customUniversal.Move6Cooldown 1
execute if score @s customUniversal.Delay4 matches 1.. run function custom:abilities/gojo/zzz/2
