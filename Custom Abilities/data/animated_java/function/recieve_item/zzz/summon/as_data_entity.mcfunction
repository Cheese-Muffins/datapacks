...
summon minecraft:item_display ^0 ^0 ^0 {Tags:["aj.global.bone.item_rig.child","aj.global.bone.item_rig.child.locator","aj.global.bone.item_rig.decendant","aj.global.bone.item_rig.decendant.locator","aj.global.bone.item_rig.tree","aj.global.entity","aj.global.locator","aj.global.node","aj.global.node.item_locator","aj.new","aj.recieve_item.bone.item_rig.child","aj.recieve_item.bone.item_rig.child.locator","aj.recieve_item.bone.item_rig.decendant","aj.recieve_item.bone.item_rig.decendant.locator","aj.recieve_item.bone.item_rig.tree","aj.recieve_item.entity","aj.recieve_item.locator","aj.recieve_item.locator.item_locator","aj.recieve_item.node","aj.recieve_item.node.item_locator"]}
execute as @n[ type=minecraft:item_display, tag=aj.new, tag=aj.recieve_item.locator.item_locator, distance=..2 ] run function animated_java:recieve_item/zzz/summon/as_data_entity/as_locator/item_locator
...
execute on vehicle on passengers if entity @s[tag=aj.recieve_item.node.item] run function animated_java:global/internal/gu/convert_uuid_array_to_string
data modify entity @s data.uuids.item_display_item set from storage aj:uuid main.out