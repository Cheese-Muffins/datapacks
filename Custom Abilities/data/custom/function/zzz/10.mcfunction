...
execute as @n[type=!#custom:not_mob,distance=..1.75] if entity @s[type=minecraft:player] run function custom:zzz/11
...
execute if score @s customBilly.TrapSuccess matches 1 run function custom:zzz/12 with storage minecraft:custom billy.trap