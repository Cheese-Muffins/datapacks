...
execute as @n[type=minecraft:item_display,tag=new] run visibility disable @s @ap
...
execute as @e[type=chest_minecart,tag=new] run function custom:ui/menu/pages/abilities/menu/open
