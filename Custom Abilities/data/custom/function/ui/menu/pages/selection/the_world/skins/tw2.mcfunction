...
function custom:ui/menu/pages/selection/purchase/check/advancements {advancement:"minecraft:nether/get_wither_skull",product:"tw2",storage:"the_world",name:"The World 2"}
