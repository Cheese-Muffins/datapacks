...
$execute if score @s customUI.PurchaseUsername matches 0 run function custom:ui/menu/pages/selection/purchase/check/zzz/3 with storage minecraft:ui custom.selection.$(storage)
