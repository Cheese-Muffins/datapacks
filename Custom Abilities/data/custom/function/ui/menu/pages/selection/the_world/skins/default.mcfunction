...
execute at @s as @p run function custom:ui/menu/pages/selection/the_world/skins/zzz/10
...
execute at @s as @p run function custom:ui/menu/pages/selection/the_world/skins/zzz/11