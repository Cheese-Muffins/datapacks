...
execute at @s as @p run function custom:ui/menu/pages/selection/eren/skins/zzz/2
...
execute at @s as @p run function custom:ui/menu/pages/selection/eren/skins/zzz/3