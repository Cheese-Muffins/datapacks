...
execute if entity @s[tag=customPresident.SkinContext] run function custom:ui/menu/pages/selection/purchase/zzz/3 with storage minecraft:ui custom.purchase
