...
$execute if score .Party$(increment) customUI.Party matches 1.. run function custom:ui/menu/pages/cassettes/party/zzz/8 with storage minecraft:custom cassette.party