...
execute if score @s customUI.CollectionOperation matches 3 run function custom:ui/menu/pages/cassettes/collection/operation/playlist1 with storage minecraft:custom cassette.fetch
