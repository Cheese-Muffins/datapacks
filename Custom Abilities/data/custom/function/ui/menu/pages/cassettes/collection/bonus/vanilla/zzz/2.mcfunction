...
$execute if entity @s[advancements={custom:cassettes/ownership/$(lookup)=true}] run function custom:ui/menu/pages/cassettes/collection/bonus/vanilla/zzz/3 with storage minecraft:custom cassette.fetch