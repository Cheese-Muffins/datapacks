...
function custom:ui/menu/pages/cassettes/menu/play/zzz/6 with storage minecraft:custom cassette.play
execute unless entity @s[tag=temp] run function custom:ui/menu/pages/cassettes/menu/play/playlist1
tag @s remove temp