...
$execute if entity @s[advancements={custom:cassettes/$(lookup)=true}] run function custom:ui/menu/pages/cassettes/collection/bonus/zzz/3 with storage minecraft:custom cassette.fetch