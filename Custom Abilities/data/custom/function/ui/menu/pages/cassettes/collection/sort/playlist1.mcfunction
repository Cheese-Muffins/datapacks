...
function custom:ui/menu/pages/cassettes/collection/sort/zzz/38 with storage minecraft:custom cassette.fetch
# searching for right page
execute if score .indexOffset customUI.CassetteCollection matches 1.. run function custom:ui/menu/pages/cassettes/collection/sort/zzz/46 with storage minecraft:custom cassette.fetch
# continue the search
