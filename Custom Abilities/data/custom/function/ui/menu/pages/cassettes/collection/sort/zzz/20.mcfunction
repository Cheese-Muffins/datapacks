...
$execute if entity @s[advancements={custom:cassettes/$(lookup)=true}] run function custom:ui/menu/pages/cassettes/collection/sort/zzz/21 with storage minecraft:custom cassette.fetch