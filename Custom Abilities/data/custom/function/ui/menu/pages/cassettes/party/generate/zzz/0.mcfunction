...
$execute if score .Party$(increment) customUI.CassetteParty matches 1.. run function custom:ui/menu/pages/cassettes/party/generate/zzz/1 with storage minecraft:custom cassette.party