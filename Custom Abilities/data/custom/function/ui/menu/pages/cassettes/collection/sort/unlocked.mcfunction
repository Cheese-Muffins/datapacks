...
function custom:ui/menu/pages/cassettes/collection/sort/zzz/17 with storage minecraft:custom cassette.fetch
...
execute if score .indexOffset customUI.CassetteCollection matches 1.. run function custom:ui/menu/pages/cassettes/collection/sort/zzz/24 with storage minecraft:custom cassette.fetch
# continue the search
