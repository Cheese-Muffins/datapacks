...
function custom:ui/menu/pages/cassettes/collection/sort/zzz/35 with storage minecraft:custom cassette.fetch
...
execute unless score .indexOffset customUI.CassetteCollection matches 1.. run function custom:ui/menu/pages/cassettes/collection/sort/zzz/39
...
# continue the search
execute unless score .incrementIndex customUI.CassetteCollection matches 105.. run function custom:ui/menu/pages/cassettes/collection/sort/alphabetical