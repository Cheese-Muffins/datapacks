...
execute at @s as @p run function custom:ui/menu/pages/abilities/selection/president/skins/zzz/2
...
execute at @s as @p run function custom:ui/menu/pages/abilities/selection/president/skins/zzz/3