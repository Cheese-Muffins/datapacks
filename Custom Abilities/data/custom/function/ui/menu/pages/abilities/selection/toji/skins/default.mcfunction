...
execute at @s as @p run function custom:ui/menu/pages/abilities/selection/toji/skins/zzz/4
...
function custom:ui/menu/pages/abilities/selection/toji/skins/open
execute at @s as @p run function custom:ui/menu/pages/abilities/selection/toji/skins/zzz/5