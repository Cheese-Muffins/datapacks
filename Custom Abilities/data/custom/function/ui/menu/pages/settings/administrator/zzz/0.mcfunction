...
execute if entity @s[tag=customSettings.Bypass] run function custom:ui/menu/pages/settings/administrator/zzz/3
execute if entity @s[tag=customSettings.DebugLog] run function custom:ui/menu/pages/settings/administrator/zzz/4