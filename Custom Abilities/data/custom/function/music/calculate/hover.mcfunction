...
$execute if score .Rating customUI.Collection matches 0..2 run data merge storage minecraft:custom {cassette:{index:{$(song_id):{targeted_color:"green",sfx:"minecraft:cassette.award.easy"}}}}
$execute if score .Rating customUI.Collection matches 3..4 run data merge storage minecraft:custom {cassette:{index:{$(song_id):{targeted_color:"dark_purple",sfx:"minecraft:cassette.award.medium"}}}}
$execute if score .Rating customUI.Collection matches 5 run data merge storage minecraft:custom {cassette:{index:{$(song_id):{targeted_color:"yellow",sfx:"minecraft:cassette.award.hard"}}}}
