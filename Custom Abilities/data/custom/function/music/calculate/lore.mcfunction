...
$execute unless score .incrementIndex customUI.Collection matches 121.. run function custom:music/calculate/zzz/0 with storage minecraft:custom cassette.index.$(song_id)