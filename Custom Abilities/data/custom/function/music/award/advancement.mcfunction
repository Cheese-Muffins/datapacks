...
# Antidote
execute if entity @s[advancements={custom:cassettes/challenge/cure_poison=true}] unless entity @s[tag=customCassette.Unlocked12] run function custom:music/award/give {id:12}
# Seperate Ways
execute if entity @s[advancements={custom:cassettes/challenge/hold/seperate_ways=true}] unless entity @s[tag=customCassette.Unlocked13] run function custom:music/award/announce {id:13}
# Popular Monster
execute if entity @s[advancements={minecraft:adventure/hero_of_the_village=true}] unless entity @s[tag=customCassette.Unlocked14] run function custom:music/award/give {id:14}
# Pesché Rap
execute if entity @s[advancements={minecraft:adventure/trim_with_all_exclusive_armor_patterns=true}] unless entity @s[tag=customCassette.Unlocked15] run function custom:music/award/give {id:15}
# Rumbling
execute if entity @s[advancements={minecraft:nether/summon_wither=true}] unless entity @s[tag=customCassette.Unlocked16] run function custom:music/award/give {id:16}
# Mikasa
execute if entity @s[advancements={minecraft:adventure/overoverkill=true}] unless entity @s[tag=customCassette.Unlocked19] run function custom:music/award/give {id:19}
# Lucid Dreams
