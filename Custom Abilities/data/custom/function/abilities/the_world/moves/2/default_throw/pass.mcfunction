...
# move arguments
function custom:abilities/the_world/moves/setup {rig:"the_world",objective:"customUniversal.AbilityID",animation:'default_knife_throw',idle:0}
...
function custom:abilities/the_world/moves/2/default_throw/zzz/0 with storage minecraft:custom the_world.knife_throw
# variable payload
