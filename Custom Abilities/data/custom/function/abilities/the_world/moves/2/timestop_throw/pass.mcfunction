...
# move arguments
function custom:abilities/the_world/moves/setup {rig:"the_world",objective:"customUniversal.AbilityID",animation:'timestop_knife_throw',idle:0}
...
function custom:universal/setup/pair {target:"type=minecraft:item_display,tag=aj.the_world.bone.left_arm_group",objective_before:"customUniversal.AbilityID",objective_target:"customTheWorld.KnifeThrowID"}
function custom:universal/setup/pair {target:"type=minecraft:item_display,tag=aj.the_world.bone.left_forearm_group",objective_before:"customUniversal.AbilityID",objective_target:"customTheWorld.KnifeThrowID"}
...
function custom:universal/setup/pair {target:"type=minecraft:item_display,tag=aj.the_world.bone.knife4",objective_before:"customUniversal.AbilityID",objective_target:"customTheWorld.KnifeThrowID"}
function custom:abilities/the_world/moves/2/timestop_throw/zzz/1 with storage minecraft:custom the_world.knife_throw
# variable payload
