...
function custom:universal/vfx/spawn {mode:1,speed:0,count:1,duration:0,branch:"the_world",animation:'knife',extra:"function custom:abilities/the_world/moves/2/setup with storage minecraft:custom the_world.knife_throw"}
