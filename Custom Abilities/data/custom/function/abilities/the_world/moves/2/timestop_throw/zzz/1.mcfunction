...
$visibility enable @n[type=minecraft:item_display,tag=aj.the_world.bone.left_arm_group,scores={customTheWorld.KnifeThrowID=$(id)}] @s
$visibility enable @n[type=minecraft:item_display,tag=aj.the_world.bone.left_forearm_group,scores={customTheWorld.KnifeThrowID=$(id)}] @s
...
$visibility enable @n[type=minecraft:item_display,tag=aj.the_world.bone.knife4,scores={customTheWorld.KnifeThrowID=$(id)}] @s