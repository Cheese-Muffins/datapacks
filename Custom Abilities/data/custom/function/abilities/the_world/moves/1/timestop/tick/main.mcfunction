...
execute unless score @s customTheWorld.TimeStopDuration matches 1.. run function custom:abilities/the_world/moves/1/timestop/tick/zzz/4 with storage minecraft:custom the_world.timestop