...
execute positioned ~ ~1 ~ run function custom:universal/vfx/spawn {mode:1,speed:0,count:1,duration:0,branch:"the_world",animation:'timestop_wind',extra:"tag @s add customUniversal.IgnoreTimestop"}
execute if entity @s[type=minecraft:player] run function custom:abilities/the_world/moves/1/timestop/freeze/zzz/1
