...
execute at @s if score @s customUniversal.Delay1 matches 1.. run function custom:abilities/avatar/tick/zzz/6
execute if score @s customAvatar.WaterArrowWindup matches 1.. at @s run function custom:abilities/avatar/tick/zzz/7
