...
$execute as @n[type=minecraft:item_display,tag=aj.toji_vfx.root,scores={customUniversal.RigID=$(id)}] align xz positioned ~0.5 ~ ~0.5 run function custom:abilities/toji/moves/3/raycast/zzz/1 with storage minecraft:custom toji.spring
