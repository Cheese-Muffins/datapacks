...
execute if score @s customUniversal.ActiveHotbar matches 1 run function custom:abilities/yuji/hotbar/zzz/6
execute if score @s customUniversal.ActiveHotbar matches 2 run function custom:abilities/yuji/hotbar/zzz/7
execute if score @s customUniversal.ActiveHotbar matches 3 run function custom:abilities/yuji/hotbar/zzz/8
function custom:abilities/yuji/hotbar/zzz/9 with storage minecraft:custom yuji.hotbar