...
execute unless entity @s[tag=customPresident.Disguised] run function custom:abilities/yuji/moves/3/zzz/0
execute if entity @s[tag=customPresident.Disguised] unless entity @s[tag=temp] run function custom:abilities/yuji/moves/3/zzz/1
tag @s remove temp