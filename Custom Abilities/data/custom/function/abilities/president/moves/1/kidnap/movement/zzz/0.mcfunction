...
# max grav
execute if score @s customPresident.KidnapGravity matches 250.. run function custom:abilities/president/moves/1/kidnap/movement/zzz/1
...
function custom:abilities/president/moves/1/kidnap/movement/zzz/2 with storage minecraft:custom president.kidnap
