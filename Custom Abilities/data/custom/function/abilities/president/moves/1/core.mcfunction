...
execute if score @s customUniversal.FailReturn matches 1 run function custom:universal/error_messages/fail {number:1,unicode:"u50A2",move:"Kidnap / Self-Kidnap"}
tag @s remove temp