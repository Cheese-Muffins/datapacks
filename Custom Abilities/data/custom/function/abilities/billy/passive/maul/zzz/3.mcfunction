...
execute if entity @s[type=minecraft:player] run function custom:abilities/billy/passive/maul/zzz/4
execute if score #ifelse mcb.internal matches 0 run function custom:abilities/billy/passive/maul/zzz/5