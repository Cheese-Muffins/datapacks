...
execute if entity @s[tag=customAbility.Billy] if score @s customUniversal.Toggle matches 1 run function custom:abilities/billy/zzz/4
...
execute if entity @s[tag=customUniversal.DisconnectCheck] run function custom:abilities/billy/zzz/7