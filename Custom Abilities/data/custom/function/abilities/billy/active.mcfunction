...
execute unless entity @s[tag=customBilly.ToggleDelay] run function custom:abilities/billy/zzz/3
execute if score @s customBilly.PassiveSnowParticles matches 20.. run function custom:abilities/billy/zzz/4 with storage minecraft:custom billy
...
function custom:abilities/billy/zzz/5 with storage minecraft:custom billy
...
execute if entity @s[tag=customBilly.PassiveHomeland] run function custom:abilities/billy/zzz/6
