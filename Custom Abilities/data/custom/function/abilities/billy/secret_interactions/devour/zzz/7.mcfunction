...
function custom:abilities/billy/secret_interactions/devour/zzz/8 with storage minecraft:custom billy
scoreboard players set #ifelse mcb.internal 0
execute if entity @s[type=minecraft:player] run function custom:abilities/billy/secret_interactions/devour/zzz/9
execute if score #ifelse mcb.internal matches 0 run function custom:abilities/billy/secret_interactions/devour/zzz/10
