...
$execute as @e[type=!#custom:not_mob,distance=..1.5] unless score @s customUniversal.RigID matches $(id) run function custom:abilities/shrinkray/beam/zzz/4 with storage minecraft:custom shrinkray.beam
