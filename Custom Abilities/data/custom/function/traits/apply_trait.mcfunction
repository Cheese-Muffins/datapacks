...
$execute unless score @s customTrait.$(path)Amplifier > .compare customTrait.$(path)Amplifier run function custom:traits/zzz/3 with storage minecraft:custom trait.universal