...
$execute as @e[type=minecraft:item_display,tag=aj.$(branch)_vfx.root] if entity @s[tag=customUniversal.VFXSpawn] run function custom:universal/vfx/zzz/2 with storage minecraft:custom universal.vfx
