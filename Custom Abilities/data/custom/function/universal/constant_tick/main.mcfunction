...
execute if entity @s[tag=!customTheWorld.BarrageVictim,tag=!customBilly.Trap] unless entity @s[scores={customBilly.EncourageBuffDuration=1..}] run tag @s remove customUniversal.ConstantCheck