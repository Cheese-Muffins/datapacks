...
execute if score @s customTheWorld.FlurryStun matches 100 run function custom:universal/constant_tick/zzz/8 with storage minecraft:custom the_world.flurry
