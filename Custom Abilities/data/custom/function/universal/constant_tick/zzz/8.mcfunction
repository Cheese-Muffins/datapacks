...
$function custom:universal/damage/victim {id:"$(id)",damage:"26",type:"minecraft:arrow",attacker:"tag=customAbility.TheWorld",objective:"customTheWorld.FlurryID",first:"was impaled by",second:"using Flurry"}
