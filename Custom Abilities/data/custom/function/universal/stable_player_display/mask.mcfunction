...
execute if items entity @s armor.head #minecraft:head_armor run function custom:universal/stable_player_display/zzz/1
execute if items entity @s armor.chest #minecraft:chest_armor run function custom:universal/stable_player_display/zzz/2
execute if items entity @s armor.legs #minecraft:leg_armor run function custom:universal/stable_player_display/zzz/3
execute if items entity @s armor.feet #minecraft:foot_armor run function custom:universal/stable_player_display/zzz/4
function custom:universal/stable_player_display/zzz/5 with storage minecraft:custom universal.stable_player_display