...
function custom:universal/damage/zzz/25 with storage minecraft:custom the_world.temp
execute unless entity @s[tag=customSettings.NoCooldowns] run function custom:universal/damage/zzz/28 with storage minecraft:custom the_world.temp
