...
function custom:universal/damage/zzz/25 with storage minecraft:custom the_world.cancelled
execute if score @s customUniversal.MoveLastUsed matches 1 run function custom:universal/damage/zzz/28
...
execute unless entity @s[tag=customSettings.NoCooldowns] run function custom:universal/damage/zzz/33 with storage minecraft:custom the_world.cancelled
