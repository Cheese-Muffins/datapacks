...
execute if items entity @s weapon.* *[minecraft:custom_data={custom_ui:1b,ability_tome:1b}] as @n[type=minecraft:chest_minecart,tag=ui,tag=customUI.StatisticsPage] run item replace entity @s container.0 with air
