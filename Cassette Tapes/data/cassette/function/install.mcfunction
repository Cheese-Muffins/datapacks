scoreboard objectives add cassette1 minecraft.used:minecraft.carrot_on_a_stick
scoreboard objectives add cassette2 dummy
scoreboard objectives add cassette3 dummy
scoreboard objectives add cassette4 dummy
...
scoreboard objectives add musicui.id dummy
scoreboard objectives add musicui.page dummy
scoreboard objectives add musicui.index dummy
scoreboard objectives add musicparty dummy
scoreboard objectives add musicopen_ui minecraft.custom:minecraft.open_barrel
...
scoreboard objectives add cassette_walk minecraft.custom:minecraft.walk_one_cm
scoreboard objectives add cassette_movement dummy
scoreboard players set divide cassette_movement 100
...
scoreboard objectives add cassette_y dummy
...
scoreboard objectives add cassette_collection dummy
scoreboard objectives add cassette_playlist dummy
scoreboard objectives add cassette_playlist1icon dummy
scoreboard objectives add cassette_playlist1color dummy
