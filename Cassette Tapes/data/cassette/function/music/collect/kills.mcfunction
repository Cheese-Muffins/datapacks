...
execute if score @s cassette_monsterkills matches 1000.. if entity @s[tag=!C36] run function cassette:music/songs/36 {storage:"cassette",path:"collect",tag:"C36",eparen:""}
