...
data merge storage minecraft:ui {cassette:{path:"offset"}}
function cassette:ui/menu/pages/collection/songs/load/style with storage minecraft:ui cassette

execute unless score @s cassetteCollection.Song matches 109.. run function cassette:ui/menu/pages/collection/songs/load/offset/recursive
