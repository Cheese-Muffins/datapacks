...
execute if score .button ui matches 4 at @s at @p run playsound minecraft:item.book.page_turn record @s ~ ~ ~
execute if score .button ui matches 4 run scoreboard players set @s ui.page 4
execute if score .button ui matches 8 at @s at @p run playsound minecraft:item.book.page_turn record @s ~ ~ ~
