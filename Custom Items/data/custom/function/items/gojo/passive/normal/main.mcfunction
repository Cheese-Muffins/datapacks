execute unless entity @p[nbt={active_effects:[{id:"minecraft:speed",amplifier:2b}]}] unless entity @s[tag=gojoPassive] run function custom:items/gojo/passive/normal/setup
