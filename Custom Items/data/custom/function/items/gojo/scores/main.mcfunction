...
execute unless entity @s[tag=RandomUser] unless entity @s[scores={customMove1Cooldown=0,customMove2Cooldown=0,customMove3Cooldown=0,customMove4Cooldown=0,customMove5Cooldown=0,customMove6Cooldown=0}] run function custom:items/gojo/scores/moves
execute unless entity @s[scores={customDelay1=0,customDelay2=0,customDelay3=0,customDelay4=0,customDelay5=0,customDelay6=0}] run function custom:items/gojo/scores/delays
execute unless entity @s[tag=RandomUser] unless entity @s[scores={customMove1Cooldown=0..}] unless entity @s[scores={customMove2Cooldown=0..}] unless entity @s[scores={customMove3Cooldown=0..}] unless entity @s[scores={customMove4Cooldown=0..}] unless entity @s[scores={customMove5Cooldown=0..}] unless entity @s[scores={customMove6Cooldown=0..}] unless entity @s[scores={customParticleDelay=0..}] unless entity @s[scores={customToggleDelay=0}] unless entity @s[scores={customToggle=1..}] run function custom:items/gojo/scores/enable
