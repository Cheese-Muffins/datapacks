...
execute store result score @s customRandomPassiveValue run random roll 1..7
...
execute if score @s customRandomPassiveValue matches 5 run function custom:items/random/roll/passives/title {title:"President",hover:"Gives access to the Freezer in the Icebox",color:"green"}
