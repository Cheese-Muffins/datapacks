...
clear @s
data merge storage minecraft:custom {random:{roll:{title:"Inventory Steal",hover:"The user loses their inventory for 15s, and is granted a stick with Knockback XV",color:"red"}}}
...
schedule function custom:items/random/roll/steal/schedule 15s