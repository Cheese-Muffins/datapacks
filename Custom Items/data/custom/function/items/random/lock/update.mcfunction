...
execute store result storage minecraft:custom random.hotbar.before int 1 run scoreboard players get @s customHotBarSelectionBefore
function custom:items/random/lock/return with storage minecraft:custom random.hotbar
