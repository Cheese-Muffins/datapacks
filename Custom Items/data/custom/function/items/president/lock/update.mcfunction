...
execute store result storage minecraft:custom president.hotbar.before int 1 run scoreboard players get @s customHotBarSelectionBefore
function custom:items/president/lock/return with storage minecraft:custom president.hotbar
