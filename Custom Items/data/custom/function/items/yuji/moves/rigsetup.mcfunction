...
function custom:universal/setup/rig {objective:"customUniversal_RigID",item:"yuji"}
item modify entity @s hotbar.8 custom:hide

data merge storage minecraft:custom {yuji:{pair:{type:"minecraft:item_display",what:"aj.yuji.camera",objective:"customUniversal_RigID"}}}
