...
data merge storage minecraft:custom {yuji:{pair:{type:"minecraft:item_display",what:"aj.yuji.locator.mount",objective:"customUniversal_RigID"}}}
...
data merge storage minecraft:custom {yuji:{pair:{type:"minecraft:item",what:"customYuji.MajinMotion",objective:"customUniversal_RigID"}}}
function custom:universal/setup/pair with storage minecraft:custom yuji.pair

#data merge storage minecraft:custom {yuji:{pair:{type:"minecraft:item_display",what:"customYuji.MajinMount",objective:"customUniversal_RigID"}}}
#function custom:universal/setup/pair with storage minecraft:custom yuji.pair
