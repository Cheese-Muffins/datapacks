...
execute if score @s customAOERange matches 5 at @n[tag=aj.toji.root] as @e[type=!#custom:not_mob,tag=!TojiUser,distance=..9] run function custom:items/toji/moves/7/damage
