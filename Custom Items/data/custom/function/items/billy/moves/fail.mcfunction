...
$tellraw @s ["",{"text":"Billy Demetrius Demarcus Bartholomew James the Third - $(name):","color":"gold"}]
...
execute if entity @s[tag=error3] run tellraw @s ["",{"text":"- You're ","color":"gray"},{"text":"too close","color":"red"},{"text":" to another ","color":"gray"},{"text":"active trap!","color":"red"}]
