...
execute store result storage minecraft:custom billy.hotbar.before int 1 run scoreboard players get @s customHotBarSelectionBefore
function custom:items/billy/lock/return with storage minecraft:custom billy.hotbar
