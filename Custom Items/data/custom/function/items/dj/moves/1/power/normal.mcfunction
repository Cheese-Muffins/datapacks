...
execute if score @s customDJNotes matches 1.. run effect give @s minecraft:jump_boost 90 1 true
execute if score @s customDJNotes matches 2.. run effect give @s minecraft:haste 90 1 true
execute if score @s customDJNotes matches 3.. run effect give @s minecraft:regeneration 15 1 true
execute if score @s customDJNotes matches 3.. run effect give @s minecraft:absorption 45 0 true
execute if score @s customDJNotes matches 4.. run effect give @s minecraft:strength 45 0 true
