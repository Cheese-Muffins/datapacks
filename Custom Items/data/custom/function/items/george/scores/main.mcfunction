...
execute unless entity @s[tag=RandomUser] unless entity @s[scores={customMove1Cooldown=0,customMove2Cooldown=0,customMove3Cooldown=0}] run function custom:items/george/scores/moves
...
execute if score @s customGeorgeComsumableCooldown matches 1.. run scoreboard players remove @s customGeorgeComsumableCooldown 1