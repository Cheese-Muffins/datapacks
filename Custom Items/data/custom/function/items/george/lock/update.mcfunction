...
execute store result storage minecraft:custom george.hotbar.before int 1 run scoreboard players get @s customHotBarSelectionBefore
function custom:items/george/lock/return with storage minecraft:custom george.hotbar
