data modify block 0 -51 0 Items[{Slot:0b}] set from storage minecraft:custom george.combustable.store
...
data remove storage minecraft:custom george.combustable.store