execute as @e[tag=!ShrinkrayUser,tag=!shrinkSmall,type=!#custom:not_mob,dx=0] positioned ~-0.99 ~-0.99 ~-0.99 if entity @s[dx=0] positioned ~0.99 ~0.99 ~0.99 run function custom:items/shrinkray/shrink/raycast/hit
