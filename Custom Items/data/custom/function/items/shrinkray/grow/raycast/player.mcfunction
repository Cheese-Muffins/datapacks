tellraw @s ["",{"text":"Shrink Ray","color":"gold"},{"text":"\n"},{"text":"You've been ","color":"gray"},{"text":"sized up","color":"dark_green"},{"text":" for ","color":"gray"},{"text":"30s!","color":"dark_green"},{"text":" You perform most actions with ","color":"gray"},{"text":"better ","color":"green"},{"text":"performance at the cost of mobility...","color":"gray"}]
