attribute @s minecraft:generic.movement_speed base set 0.110000000149011612
attribute @s minecraft:generic.step_height base set 1.5
attribute @s minecraft:generic.max_health base set 24
attribute @s minecraft:generic.scale base set 1.5
attribute @s minecraft:generic.jump_strength base set 0.52
