...
execute if entity @s[tag=GeorgeUser] as @s[nbt={SelectedItem:{components:{"minecraft:custom_model_data":1020}}}] unless score @s customToggleDelay matches 1.. run function custom:items/george/toggle

execute if entity @s[tag=ExplorerUser] as @s[nbt={SelectedItem:{components:{"minecraft:custom_model_data":1021}}}] unless score @s customToggleDelay matches 1.. if predicate custom:sneak run function custom:items/explorer/toggle
execute if entity @s[tag=ExplorerUser] as @s[nbt={SelectedItem:{components:{"minecraft:custom_model_data":1021}}}] unless score @s customToggleDelay matches 1.. unless predicate custom:sneak if score @s customToggle matches 1 run function custom:items/explorer/moves/main
