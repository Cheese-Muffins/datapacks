tellraw @s ["",{"text":"Custom Items - Settings","color":"gold"},{"text":"\n"},{"text":"You've been given the ","color":"gray"},{"text":"Bastion of Strength Fragment!","color":"aqua"}]
...
scoreboard players set @n[type=minecraft:item_display,tag=aj.fragments.root] customExplorer_FragmentID 6
