...
execute if entity @s[tag=error8] run tellraw @s ["",{"text":"- You ","color":"gray"},{"text":"CAN'T","color":"red"},{"text":" use this move whilst being targeted by ","color":"gray"},{"text":"Pact!","color":"aqua"}]

execute if entity @s[tag=error9] run scoreboard players operation @s customMoveCooldownMath = @s customEren.ShiftCooldown
execute if entity @s[tag=error9] run scoreboard players operation @s customMoveCooldownMath /= #divide customMoveCooldownMath
execute if entity @s[tag=error9] run tellraw @s ["",{"text":"- You can't attempt to ","color":"gray"},{"text":"shift","color":"gold"},{"text":" into the ","color":"gray"},{"text":"Attack Titan","color":"aqua"},{"text":" for another ","color":"gray"},{"score":{"name":"@s","objective":"customMoveCooldownMath"},"color":"red"},{"text":"s!","color":"red"}]
