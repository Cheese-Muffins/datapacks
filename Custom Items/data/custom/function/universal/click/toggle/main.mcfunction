...
execute if entity @s[tag=YujiUser] run function custom:universal/click/toggle/search {item:"yuji"}
execute if entity @s[tag=ErenUser] run function custom:universal/click/toggle/search {item:"eren"}
