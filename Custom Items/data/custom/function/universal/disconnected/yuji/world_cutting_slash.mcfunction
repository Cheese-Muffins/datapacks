...
tag @s remove customYuji.WorldCuttingSlash_User
tag @s remove customYuji.WorldCuttingSlash_Victim
tag @s remove customUniversal_HideHUD

damage @s 16 generic_kill

tellraw @s ["",{"text":"Custom Abilities (Sukuna)","color":"gold"},{"text":"\n"},{"text":"- You've ","color":"gray"},{"text":"disconnected ","color":"yellow"},{"text":"whilst being nearby ","color":"gray"},{"text":"World Cutting Slash","color":"aqua"},{"text":", so you've been ","color":"gray"},{"text":"heavily punished.","color":"red"}]
