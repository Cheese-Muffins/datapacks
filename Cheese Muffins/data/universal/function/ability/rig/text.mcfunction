...
# as the text node
execute as @n[type=minecraft:text_display,tag=aj.text_display.text_display.display,tag=!universalText.IDAssigned] run function universal:ability/rig/zzz/4 with storage minecraft:universal ability.rig.text
# as the text root
execute as @n[type=minecraft:item_display,tag=aj.text_display.root,tag=!universalText.IDAssigned] run function universal:ability/rig/zzz/5 with storage minecraft:universal ability.rig.text
