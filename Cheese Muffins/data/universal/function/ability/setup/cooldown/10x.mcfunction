...
$scoreboard players operation .$(name)CooldownDivided universalAbility.MoveCooldown$(move) = .$(name)Cooldown universalAbility.MoveCooldown$(move)
$function universal:math/divide {value:11,score:".$(name)CooldownDivided",objective:"universalAbility.MoveCooldown$(move)"}
$execute store result storage minecraft:ability $(storage).cooldown.move$(path).11 int 1 run scoreboard players get .$(name)CooldownThresholds universalAbility.MoveCooldown$(move)
...
$execute store result storage minecraft:ability $(storage).cooldown.move$(path).10a int 1 run scoreboard players get .$(name)CooldownThresholds universalAbility.MoveCooldown$(move)
$scoreboard players remove .$(name)CooldownThresholds universalAbility.MoveCooldown$(move) 1
$execute store result storage minecraft:ability $(storage).cooldown.move$(path).10b int 1 run scoreboard players get .$(name)CooldownThresholds universalAbility.MoveCooldown$(move)
$scoreboard players operation .$(name)CooldownThresholds universalAbility.MoveCooldown$(move) -= .$(name)CooldownDivided universalAbility.MoveCooldown$(move)
$execute store result storage minecraft:ability $(storage).cooldown.move$(path).9a int 1 run scoreboard players get .$(name)CooldownThresholds universalAbility.MoveCooldown$(move)
$scoreboard players remove .$(name)CooldownThresholds universalAbility.MoveCooldown$(move) 1
$execute store result storage minecraft:ability $(storage).cooldown.move$(path).9b int 1 run scoreboard players get .$(name)CooldownThresholds universalAbility.MoveCooldown$(move)
$scoreboard players operation .$(name)CooldownThresholds universalAbility.MoveCooldown$(move) -= .$(name)CooldownDivided universalAbility.MoveCooldown$(move)
