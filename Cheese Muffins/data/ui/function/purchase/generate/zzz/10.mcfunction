...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name){type:"ability"} run function ui:purchase/generate/zzz/11 with storage minecraft:ui generate.purchase
...
function ui:purchase/generate/zzz/13 with storage minecraft:ui generate.purchase