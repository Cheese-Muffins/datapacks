...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).bypass run function ui:purchase/generate/zzz/4 with storage minecraft:ui generate.purchase
...
function ui:purchase/generate/zzz/6 with storage minecraft:ui generate.purchase