...
$execute if score .item3Count uiPurchase.Broad matches $(request_count).. run data modify storage minecraft:ui generate.purchase.request_color set value "3cdd31"
