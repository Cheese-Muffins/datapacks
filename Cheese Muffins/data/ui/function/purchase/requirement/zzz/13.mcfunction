...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request3.tag run function ui:purchase/requirement/zzz/14 with storage minecraft:ui generate.purchase
...
function ui:purchase/requirement/zzz/16 with storage minecraft:ui generate.purchase