...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request4.tag run function ui:purchase/zzz/43 with storage minecraft:ui generate.purchase
...
function ui:purchase/zzz/45 with storage minecraft:ui generate.purchase