...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request1.tag run function ui:purchase/zzz/9 with storage minecraft:ui generate.purchase
