...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request2.tag run function ui:purchase/zzz/13 with storage minecraft:ui generate.purchase
