...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request1.tag run function ui:purchase/zzz/27 with storage minecraft:ui generate.purchase
...
function ui:purchase/zzz/29 with storage minecraft:ui generate.purchase