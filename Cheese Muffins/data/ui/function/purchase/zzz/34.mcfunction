...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request3.tag run function ui:purchase/zzz/35 with storage minecraft:ui generate.purchase
