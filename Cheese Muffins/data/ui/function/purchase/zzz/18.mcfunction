...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request4.tag run function ui:purchase/zzz/19 with storage minecraft:ui generate.purchase
...
function ui:purchase/zzz/21 with storage minecraft:ui generate.purchase