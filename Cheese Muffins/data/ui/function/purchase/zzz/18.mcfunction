...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name){type:"ability"} run function ui:purchase/zzz/19 with storage minecraft:ui generate.purchase
