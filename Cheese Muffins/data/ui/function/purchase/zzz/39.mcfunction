...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request4.tag run function ui:purchase/zzz/40 with storage minecraft:ui generate.purchase
...
function ui:purchase/zzz/42 with storage minecraft:ui generate.purchase