...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request4.tag run function ui:purchase/zzz/39 with storage minecraft:ui generate.purchase
