...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request3.tag run function ui:purchase/zzz/36 with storage minecraft:ui generate.purchase
...
function ui:purchase/zzz/38 with storage minecraft:ui generate.purchase