...
$execute if data storage minecraft:ability index.$(ability_id).product.$(product_name).items.request2.tag run function ui:purchase/zzz/32 with storage minecraft:ui generate.purchase
...
function ui:purchase/zzz/34 with storage minecraft:ui generate.purchase