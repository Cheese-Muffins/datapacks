...
$execute if entity @s[advancements={cassette:ownership/$(lookup)=true}] run function ui:ability/selection/generate/slot/zzz/9 with storage minecraft:cassette fetch