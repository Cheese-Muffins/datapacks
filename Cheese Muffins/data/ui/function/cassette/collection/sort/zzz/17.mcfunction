...
execute if entity @s[tag=cassettePlay.FeedbackIncrementing] if score @s cassettePlay.FeedbackIncrement = .totalPassed uiCassette.CollectionBroad run function ui:cassette/collection/sort/zzz/18 with storage minecraft:cassette fetch
