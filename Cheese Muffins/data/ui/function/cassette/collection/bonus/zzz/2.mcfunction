...
$execute if entity @s[advancements={custom:cassettes/ownership/$(lookup)=true}] run function ui:cassette/collection/bonus/zzz/3 with storage minecraft:custom cassette.fetch