...
data modify storage minecraft:cassette fetch.click_id set from block 0 -64 0 Items[0].components."minecraft:custom_data".ui_item.song_id
data modify storage minecraft:cassette fetch.slot_entry set from block 0 -64 0 Items[0].components."minecraft:custom_data".ui_item.slot_entry
