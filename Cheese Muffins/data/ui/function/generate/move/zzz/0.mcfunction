...
$execute if data storage minecraft:ability index.$(ability_id).moveset.slot$(slot).move2 run function ui:generate/move/zzz/7 with storage minecraft:ui generate.move
$execute if data storage minecraft:ability index.$(ability_id).moveset.slot$(slot).move3 run function ui:generate/move/zzz/13 with storage minecraft:ui generate.move
