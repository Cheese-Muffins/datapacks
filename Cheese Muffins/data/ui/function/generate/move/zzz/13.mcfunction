...
function ui:generate/move/zzz/14 with storage minecraft:ui generate.move
...
execute if score .cooldownMinutes uiAbility.Moveset matches 1.. run function ui:generate/move/zzz/16 with storage minecraft:ui generate.move
execute if score .cooldownSeconds uiAbility.Moveset matches 1.. run function ui:generate/move/zzz/17 with storage minecraft:ui generate.move
