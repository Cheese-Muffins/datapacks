...
scoreboard players set .moveIndex uiAbility.Moveset 3
...
$data modify storage minecraft:ui generate.move.lore append from storage minecraft:ability index.$(ability_id).moveset.slot$(slot).move3.description[]
data modify storage minecraft:ui generate.move.lore append value ""
function ui:generate/move/zzz/18 with storage minecraft:ui generate.move
$execute store result score .cooldownRaw uiAbility.Moveset run data get storage minecraft:ability index.$(ability_id).moveset.slot$(slot).move3.cooldown
...
execute if score .cooldownMinutes uiAbility.Moveset matches 1.. run function ui:generate/move/zzz/22 with storage minecraft:ui generate.move
execute if score .cooldownSeconds uiAbility.Moveset matches 1.. run function ui:generate/move/zzz/23 with storage minecraft:ui generate.move
...
$execute if data storage minecraft:ability index.$(ability_id).moveset.slot$(slot).move3{cancelable:false} run data merge storage minecraft:ui {generate:{move:{cancelable_text:"No",cancelable_color:"00ff40"}}}
function ui:generate/move/zzz/24 with storage minecraft:ui generate.move
$data modify storage minecraft:ability index.$(ability_id).moveset.slot$(slot).move3.generated set from storage minecraft:ui generate.move.lore