...
execute if score .cooldownMinutes uiAbility.Moveset matches 1.. run function ui:generate/move/zzz/10 with storage minecraft:ui generate.move
execute if score .cooldownSeconds uiAbility.Moveset matches 1.. run function ui:generate/move/zzz/11 with storage minecraft:ui generate.move
...
function ui:generate/move/zzz/12 with storage minecraft:ui generate.move
