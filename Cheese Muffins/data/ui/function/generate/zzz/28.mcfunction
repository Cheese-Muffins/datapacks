...
execute if data storage minecraft:ui generate.selection.secret run function ui:generate/zzz/31
...
function ui:generate/zzz/42 with storage minecraft:ui generate.selection
...
execute if data storage minecraft:ui generate.selection.product.skin1 run function ui:generate/zzz/43
execute if data storage minecraft:ui generate.selection.product.skin2 run function ui:generate/zzz/45
execute if data storage minecraft:ui generate.selection.product.skin3 run function ui:generate/zzz/47
execute if data storage minecraft:ui generate.selection.product.skin4 run function ui:generate/zzz/49
execute if data storage minecraft:ui generate.selection.product.skin5 run function ui:generate/zzz/51
...
function ui:generate/zzz/53 with storage minecraft:ui generate.selection
