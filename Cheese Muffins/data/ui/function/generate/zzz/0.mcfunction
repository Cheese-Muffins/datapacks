...
execute if score .splitMove uiAbility.Moveset matches 2.. run function ui:generate/zzz/1 with storage minecraft:ui generate.move
...
execute if score .cooldownMinutes uiAbility.Moveset matches 1.. run function ui:generate/zzz/2 with storage minecraft:ui generate.move
execute if score .cooldownSeconds uiAbility.Moveset matches 1.. run function ui:generate/zzz/3 with storage minecraft:ui generate.move
...
function ui:generate/zzz/4 with storage minecraft:ui generate.move
