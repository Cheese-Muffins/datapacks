...
$data modify storage minecraft:ui ability.selection.slot$(slot)_id set from storage minecraft:ui generate.selection.ability_id
...
$data modify storage minecraft:ui ability.selection.slot$(slot)_tooltip set from storage minecraft:ui generate.selection.path
$data modify storage minecraft:ui ability.selection.slot$(slot)_lore set from storage minecraft:ui generate.selection.lore
data modify storage minecraft:ui ability.menu.ability_lore set from storage minecraft:ui generate.selection.lore
