...
execute if data storage ui in[0] run return run function ui:logic/menu/on_input
...
execute if data storage ui in[0] unless data storage ui in[1] run return run function ui:logic/menu/on_click
function ui:logic/menu/refresh