...
scoreboard objectives add cassetteChallenge.NearbyPlayer dummy
scoreboard objectives add cassetteChallenge.DamageTaken minecraft.custom:minecraft.damage_taken
scoreboard objectives add cassetteChallenge.BlackholeSun dummy
scoreboard objectives add cassetteChallenge.DefeatZombies dummy
scoreboard objectives add cassetteChallenge.ComeAsYouAre dummy
scoreboard objectives add cassetteChallenge.UsedAnvil minecraft.custom:minecraft.interact_with_anvil
