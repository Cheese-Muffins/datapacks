...
scoreboard players set .alphabeticalTotal uiCassette.CollectionBroad 0
scoreboard players set .artistTotal uiCassette.CollectionBroad 0
data remove storage minecraft:cassette alphabetical
data remove storage minecraft:cassette artist
# BONUS SONGS!!! #
# 106 - Vanilla Bundle #
