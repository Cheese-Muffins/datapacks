...
tag @s add aj.yuji.animation.sukuna_old.playing
$scoreboard players set @s aj.tween_duration $(duration)
$scoreboard players set @s aj.sukuna_old.frame $(to_frame)
scoreboard players operation #this aj.i = @s aj.tween_duration
tag @s add aj.transforms_only
execute at @s run function aj:yuji/animations/sukuna_old/zzz/apply_frame {frame: 0}
$execute at @s run function aj:yuji/animations/sukuna_old/zzz/apply_frame {frame: $(to_frame)}
