...
execute at @s run function aj:yuji/animations/sukuna/zzz/apply_frame {frame: 0}
$execute at @s run function aj:yuji/animations/sukuna/zzz/apply_frame {frame: $(to_frame)}
