...
data modify storage animated_java:temp entry.data.blueprint_id set value "aj:text_display"
data modify storage animated_java:temp entry.data.rig_hash set value "1e700de95d59c4043640c93b8f7915525ae9a21538b6bf0a2c7c7f22449618b4"
tp @s ~ ~ ~ ~ ~
execute on passengers if entity @s[tag=aj.text_display.node.display] run function aj:text_display/zzz/summon/as_node/display
data modify storage animated_java:temp entry.data.uuids append from storage animated_java:gu out
data modify storage animated_java:temp entry.data.uuids_by_name.display set from storage animated_java:gu out
function aj:text_display/zzz/set_default_pose
# Data Manager: Write
function animated_java:global/data_manager/write with storage animated_java:temp args
execute if data storage animated_java:temp args.variant run function aj:text_display/zzz/summon/zzz/variant_arg/no_variants_warning
execute if score #success aj.i matches 0 run return fail
execute if data storage animated_java:temp args.animation run function aj:text_display/zzz/summon/animation_arg/process with storage animated_java:temp args
execute if score #success aj.i matches 0 run return fail
