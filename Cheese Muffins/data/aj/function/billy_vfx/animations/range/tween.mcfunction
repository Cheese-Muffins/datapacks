...
execute at @s run function aj:billy_vfx/animations/range/zzz/apply_frame {frame: 0}
$execute at @s run function aj:billy_vfx/animations/range/zzz/apply_frame {frame: $(to_frame)}
