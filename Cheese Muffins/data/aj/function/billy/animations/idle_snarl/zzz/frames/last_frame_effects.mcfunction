...
execute positioned ^0 ^0 ^0 rotated ~0 ~0 run function aj:billy/animations/idle_snarl/zzz/frames/51_locator_commands
execute positioned ^0 ^0 ^0 rotated ~0 ~0 run function aj:billy/animations/idle_snarl/zzz/frames/51_locator_constant
execute positioned ^0 ^0 ^0 rotated ~0 ~0 run function aj:billy/animations/idle_snarl/zzz/frames/51_locator_timestop
