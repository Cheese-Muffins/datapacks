...
execute at @s run function aj:billy/animations/encourage/zzz/apply_frame {frame: 0}
$execute at @s run function aj:billy/animations/encourage/zzz/apply_frame {frame: $(to_frame)}
