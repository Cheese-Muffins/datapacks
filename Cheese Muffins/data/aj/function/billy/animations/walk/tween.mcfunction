...
tag @s add aj.billy.animation.walk.playing
...
execute at @s run function aj:billy/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function aj:billy/animations/walk/zzz/apply_frame {frame: $(to_frame)}
