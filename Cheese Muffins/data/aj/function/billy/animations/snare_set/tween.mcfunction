...
execute at @s run function aj:billy/animations/snare_set/zzz/apply_frame {frame: 0}
$execute at @s run function aj:billy/animations/snare_set/zzz/apply_frame {frame: $(to_frame)}
