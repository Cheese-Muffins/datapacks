...
tag @s add aj.billy.animation.jump.playing
...
execute at @s run function aj:billy/animations/jump/zzz/apply_frame {frame: 0}
$execute at @s run function aj:billy/animations/jump/zzz/apply_frame {frame: $(to_frame)}
