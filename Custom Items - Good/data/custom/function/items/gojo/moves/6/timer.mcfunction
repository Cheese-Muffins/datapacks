...
execute if score @s customGojo_DomainTimer matches 0 store result storage minecraft:custom gojo.id.domain int 1 run scoreboard players get @s customUniversal_RigID
execute if score @s customGojo_DomainTimer matches 0 run function custom:items/gojo/moves/6/end with storage minecraft:custom gojo.id