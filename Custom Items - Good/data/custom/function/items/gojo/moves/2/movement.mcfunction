...
$execute as @e[type=!#custom:not_mob,tag=!customGojo_BluePickedUp,distance=..3] unless entity @s[scores={customGojo_BlueID=$(id)}] unless entity @s[tag=customGojo_BluePickedUp] run function custom:items/gojo/moves/2/pickup {id:"$(id)"}
