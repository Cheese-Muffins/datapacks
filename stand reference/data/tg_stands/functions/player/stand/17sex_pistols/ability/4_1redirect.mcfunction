execute at @s run particle minecraft:cloud ~ ~ ~ 0.1 0.1 0.1 0.2 5 force
scoreboard players set @s tg_stands.stand.stage_timer 1
scoreboard players set @s tg_stands.raycast 100
tp @s ~ ~ ~ facing entity @e[tag=tg_stands.ability_filter,limit=1] eyes
...
execute as @e[limit=1,sort=nearest,tag=tg_stands,tag=stand_ability,tag=17,tag=ability3] run tp @s ~ ~ ~ facing entity @e[tag=tg_stands.ability_filter,limit=1] eyes