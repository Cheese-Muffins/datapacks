...
scoreboard players operation $dx tg_stands.motion *= $horizontal tg_stands.motion
scoreboard players operation $dy tg_stands.motion *= $vertical tg_stands.motion
scoreboard players operation $dz tg_stands.motion *= $horizontal tg_stands.motion
