...
execute at @s as @p if items entity @s player.cursor minecraft:clay_ball[minecraft:custom_data~{ui_item:{skin_item:1b}}] as @n[type=minecraft:chest_minecart] run function custom:ui/minecart/click/start
