...
execute unless score @s customFailReturn matches 1 run function custom:items/gojo/moves/1/pass
execute if score @s customFailReturn matches 1 run function custom:universal/errors/fail {number:"1",name:"Reversed Cursed Technique",item:"Satoru Gojo"}