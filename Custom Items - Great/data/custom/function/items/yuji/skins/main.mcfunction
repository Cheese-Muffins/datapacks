...
execute if score @s customYuji.SkinState matches 0 if entity @s[tag=customAnim] if entity @s[tag=customYuji.DefaultSkin] run function custom:items/yuji/skins/default with storage minecraft:custom yuji.skins
...
execute if score @s customYuji.SkinState matches 1 if entity @s[tag=customAnim] if entity @s[tag=customYuji.DefaultSkin] run function custom:items/yuji/skins/sukuna with storage minecraft:custom yuji.skins
