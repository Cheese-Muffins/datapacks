...
execute unless score @s customFailReturn matches 1 run function custom:items/yuji/moves/6/pass
execute if score @s customFailReturn matches 1 run function custom:universal/errors/fail {number:"6",name:"Dismantle",item:"Ryomen Sukuna"}