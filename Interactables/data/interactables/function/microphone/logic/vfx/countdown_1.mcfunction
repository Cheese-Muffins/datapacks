...
execute rotated ~ 0 run function custom:universal/vfx/spawn {mode:2,speed:0,count:1,duration:0,branch:"hatsune_miku",animation:'countdown1',extra:"random value 1..2"}