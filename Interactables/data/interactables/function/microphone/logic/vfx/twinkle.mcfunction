...
execute rotated ~ 0 run function custom:universal/vfx/spawn {mode:3,speed:0,count:10,duration:0,branch:"hatsune_miku",animation:'twinkle',extra:"random value 1..2"}