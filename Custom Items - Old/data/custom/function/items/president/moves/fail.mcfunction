...
$tellraw @s ["",{"text":"Mr. President - $(name):","color":"gold"}]
...
execute if entity @s[tag=error3] run tellraw @s ["",{"text":"- Someone must be ","color":"gray"},{"text":"inside the room!","color":"red"}]
