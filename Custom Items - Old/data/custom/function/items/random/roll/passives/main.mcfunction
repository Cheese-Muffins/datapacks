...
execute if score @s customRandomPassiveValue matches 9 run function custom:items/random/roll/passives/yuji_clear
execute if score @s customRandomPassiveValue matches 10 run function custom:items/random/roll/passives/sukuna_clear


execute store result score @s customRandomPassiveValue run random value 1..10
...
execute if score @s customRandomPassiveValue matches 9 run function custom:items/random/roll/passives/title {title:"Yuji Itadori",hover:"Gives Speed and Strength",color:"red"}
execute if score @s customRandomPassiveValue matches 10 run function custom:items/random/roll/passives/title {title:"Ryomen Sukuna",hover:"Gives Speed",color:"dark_red"}