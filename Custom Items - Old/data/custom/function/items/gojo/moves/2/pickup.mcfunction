execute unless score @n[tag=aj.projectiles.root] customBluePickup matches 1.. run tag @s add gojoPickedUp
...
execute if score @n[tag=aj.projectiles.root] customBluePickup matches ..3 run tag @s add gojoPickedUp
