...
execute at @s as @n[tag=tojiAssasinateTarget] at @s run tag @s remove tojiAssasinateTarget
execute at @s as @n[tag=TojiUser,tag=!RandomUser] run gamemode survival @s
execute at @s as @n[tag=TojiUser,tag=!RandomUser] run function custom:items/toji/moves/reset
execute at @s as @n[tag=TojiUser,tag=RandomUser] run gamemode survival @s
