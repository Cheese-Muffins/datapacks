execute if entity @s[tag=DJUser] run function custom:errors/block_place/user {name:"DJ"}
execute if entity @s[tag=AvatarUser] run function custom:errors/block_place/user {name:"The Avatar"}
execute if entity @s[tag=YujiUser] run function custom:errors/block_place/user {name:"Yuji Itadori"}
execute if entity @s[tag=GojoUser] run function custom:errors/block_place/user {name:"Gojo Satoru"}
...
execute if entity @s[tag=GeorgeUser] run function custom:errors/block_place/user {name:"George"}
