...
execute if entity @s[tag=aj.satoru.animation.honored2.playing] run function animated_java:satoru/animations/honored2/zzz/on_tick
execute if entity @s[tag=aj.satoru.animation.lapis_blue_old.playing] run function animated_java:satoru/animations/lapis_blue_old/zzz/on_tick
execute if entity @s[tag=aj.satoru.animation.reversal_red_old.playing] run function animated_java:satoru/animations/reversal_red_old/zzz/on_tick
...
execute if entity @s[tag=aj.satoru.animation.domain_expansion_test.playing] run function animated_java:satoru/animations/domain_expansion_test/zzz/on_tick
