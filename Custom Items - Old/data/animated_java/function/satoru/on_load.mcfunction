...
scoreboard objectives add aj.honored2.frame dummy
scoreboard objectives add aj.lapis_blue_old.frame dummy
scoreboard objectives add aj.reversal_red_old.frame dummy
...
scoreboard objectives add aj.domain_expansion_test.frame dummy
